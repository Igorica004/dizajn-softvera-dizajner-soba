...
public class Krevet extends RoomDevice{

    public Krevet(String ime, DraftNode roditelj) {
        super(ime, roditelj);
    }

    public Krevet(String ime, DraftNode roditelj, Dimension dimenzija, Point locacija, Paint paint, double rotateRatio, Stroke stroke) {
