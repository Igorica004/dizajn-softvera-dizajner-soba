...
public class VesMasina extends RoomDevice{

    public VesMasina(String ime, DraftNode roditelj) {
        super(ime, roditelj);
    }

    public VesMasina(String ime, DraftNode roditelj, Dimension dimenzija, Point locacija, Paint paint, double rotateRatio, Stroke stroke) {
        super(ime, roditelj, dimenzija, locacija, paint, rotateRatio, stroke);
    }

    @Override
    public Prototype clone(RoomElement prototype) {
        return new VesMasina(((RoomDevice)prototype).getNaziv(),null, ((RoomDevice)prototype).getDimenzija(),
